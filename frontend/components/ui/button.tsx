...
const buttonVariants = cva(
  // Base — smooth opacity press feedback, consistent transition on all interactive states
  ...
  // Smooth press: translate + opacity together (compositor-only)
  "active:not-aria-[haspopup]:translate-y-px active:not-aria-[haspopup]:opacity-80 " +
  // Disabled
  ...
  "[&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      ...
      size: {
        ...
        xl:      "h-13 gap-2 px-8 text-lg rounded-xl has-data-[icon=inline-end]:pr-6 has-data-[icon=inline-start]:pl-6",
        icon:    "size-9",
